...
export const AMENITIES: AmenityItem[] = [
  ...
  { id: 'water', title: '24 Hrs Hot Water', subtitle: 'Continuous supply', iconName: 'water', description: '24 hours hot and cold water available in all rooms.' },
  { id: 'power', title: 'Generator Facility', subtitle: 'Uninterrupted power', iconName: 'generator', description: '100% power backup with generator facility.' },
  ...
  { id: 'solar', title: 'Solar Plant', subtitle: 'Eco-friendly', iconName: 'solar', description: 'All systems powered by an electric and water solar plant.' },
  { id: 'lift', title: 'Lift Service', subtitle: 'Easy access', iconName: 'lift', description: 'Elevator access available to all floors.' },
  { id: 'tv', title: 'TV Channels', subtitle: 'Entertainment', iconName: 'tv', description: 'Cable TV channel service available in every room.' },
  ...
  { id: 'spa', title: 'Spa Facility', subtitle: 'Relaxation', iconName: 'spa', description: 'Rejuvenate yourself with our premium spa facility.' },
  { id: 'hall', title: 'Conference Hall', subtitle: 'Marriage & events', iconName: 'conference', description: 'Spacious conference and marriage hall for your special events.' },
  { id: 'garden', title: 'Garden Area', subtitle: 'Peaceful', iconName: 'garden', description: 'Lush green garden area and playground for children.' },
...
export const SACRED_PLACES: SacredPlace[] = [
  ...
  },
  {
    ...
    badge: '5 mins drive',
    image: '/images/Sai Teerth Spiritual Theme Park.png',
  ...
  },
  {
    ...
    badge: 'Walkable',
    image: '/images/Lendi Baug Garden.png',
  ...
  },
  {
    ...
    image: '/images/Dixit Wada Museum.png',
  ...
  },
  {
    ...
    badge: 'Nashik (90km)',
    image: '/images/Trimbakeshwar Shiva Temple.png',
  ...
  },
  {
    ...
    name: 'Sula Vineyards',
    badge: 'Nashik (90km)',
    image: '/images/Sula Vineyards.png',
  ...
  },
  {
    ...
    badge: 'Nashik (85km)',
    image: '/images/Panchavati & Ramkund.png',
  ...
  },
  {
    ...
    badge: 'Nashik (95km)',
    image: '/images/Pandavleni Caves.png',
  ...
  },
  {
    ...
    badge: '70km Away',
    image: '/images/Shani Shingnapur.png',
